                ...
                child: TabBarView(
                  ...
                  Consumer<ResellerController>(
                      builder: (context, resellerProvider, child) {
                        ...
                        return FutureBuilder(future: resellerProvider.getResellerinfo(resellerID.id.toString()), builder: (context,snapshot){
                  ...
                  Consumer<ResellerController>(
                      builder: (context, resellerProvider, child) {
                        return FutureBuilder(future: resellerProvider.getDbetPayinfo(resellerID.id.toString()), builder: (context,snapshot){
                          if(snapshot.hasError){
                            return Text(snapshot.error.toString());
                          }
                          else if(snapshot.hasData){
